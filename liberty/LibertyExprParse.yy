...
#include "liberty/LibertyExpr.hh"  // cdli
#include "liberty/LibertyExprPvt.hh"  // cdli

int LibertyExprLex_lex();  // cdli
#define LibertyExprParse_lex LibertyExprLex_lex  // cdli

%}

%union {
  int int_val;  // cdli
  const char *string;  // cdli
  sta::FuncExpr *expr;  // cdli
}
...
%type <string> PORT  // cdli
%type <expr> expr terminal terminal_expr implicit_and  // cdli
